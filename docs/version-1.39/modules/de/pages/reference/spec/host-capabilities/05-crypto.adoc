...
Aufgrund der Wasm-Einschränkungen zum Zeitpunkt des Schreibens können einige kryptografische Bibliotheken nicht in Wasm kompiliert werden. In der Zwischenzeit können {admc-name} Richtlinien, die diese Bibliotheken benötigen, Rückrufe durchführen, um die kryptografischen Funktionen auf der Host-Seite zu bewerten. Sie erhalten das Ergebnis und setzen ihre Aufgaben fort.
