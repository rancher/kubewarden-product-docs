...
En términos de ejecución de directivas, puedes leer más sobre el xref:tutorials/writing-policies/rego/02-builtin-support.adoc[soporte integrado de OPA] implementado en {admc-short-name}.
