...
:keywords: ["{admc-name}", "kubewarden", "stratégie de mutation", "kubernetes", "clusteradmissionpolicy", "admissionpolicy"]
...
Pour prévenir les abus du système, les administrateurs {admc-name} devraient examiner les stratégies de mutation. Les stratégies de mutation pourraient, par exemple, modifier une charge de travail, de sorte qu'elle permette la création de conteneurs privilégiés.
...
En conclusion, vous pouvez voir que {admc-short-name} reproduit le même comportement que les politiques de sécurité des pods Kubernetes (PSP) dont la prise en charge a cessé.
