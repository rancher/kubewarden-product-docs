...
Pour réaliser cela en CEL, nous utilisons les https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[bibliothèques d'extension CEL de {admc-name} pour les capacités d'hôte] dans la stratégie, en particulier la https://pkg.go.dev/github.com/kubewarden/cel-policy/internal/cel/library#Sigstore[fonction `githubAction`].
