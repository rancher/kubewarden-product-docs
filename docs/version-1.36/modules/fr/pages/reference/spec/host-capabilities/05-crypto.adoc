...
En raison des contraintes de Wasm au moment de la rédaction, certaines bibliothèques cryptographiques ne peuvent pas être compilées en Wasm. En attendant, les politiques {admc-name} nécessitant ces bibliothèques peuvent effectuer des appels de retour pour évaluer les fonctions cryptographiques du côté de l'hôte. Elles reçoivent le résultat et poursuivent leurs tâches.
