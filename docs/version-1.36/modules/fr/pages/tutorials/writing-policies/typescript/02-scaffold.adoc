...
:keywords: {admc-name}, kubewarden, kubernetes, rédaction de stratégies en TypeScript, nouvelle stratégie de validation
:doc-type: didacticiel
:doc-topic: {admc-name}, kubewarden, rédaction de stratégies, typescript, création d'une nouvelle stratégie de validation
