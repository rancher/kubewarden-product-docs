...
Vous devez également mettre à jour la structure `ValidationResponse` et la fonction `MutateRequest` dans `kw_sdk.go` pour supprimer les types spécifiques à Kubernetes et utiliser les types {admc-short-name} à la place :
