...
En termes d'exécution de stratégies, vous pouvez en savoir plus sur le xref:tutorials/writing-policies/rego/02-builtin-support.adoc[support intégré OPA] mis en œuvre dans {admc-short-name}.
