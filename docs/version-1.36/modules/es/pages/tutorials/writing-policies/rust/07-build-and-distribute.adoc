...
:description: Sigue estos pasos esenciales para construir y distribuir directivas de manera efectiva para tu configuración de {admc-name}.
...
{admc-name} documenta la distribución de directivas en la sección de
xref:../../../explanations/distributing-policies.adoc[distribución de directivas].

== Más ejemplos

Puedes encontrar más directivas de Rust {admc-short-name} en el espacio de GitHub de {admc-short-name}.
...
Los repositorios de directivas {admc-short-name}, mostrados por esa consulta, tienen acciones de GitHub que automatizan las siguientes tareas:
