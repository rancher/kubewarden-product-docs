...
Una directiva de {admc-short-name} expone dos funciones diferentes que reciben los ajustes de la directiva como entrada:
...
* `validate_settings`: Llama a esta función cuando la directiva se cargue por primera vez en {admc-short-name}.
...
Todas las directivas de {admc-short-name} deben implementar la validación de ajustes.
...
Puedes ver que la función aprovecha las funciones auxiliares proporcionadas por https://github.com/kubewarden/policy-sdk-go[{admc-short-name} del SDK].
