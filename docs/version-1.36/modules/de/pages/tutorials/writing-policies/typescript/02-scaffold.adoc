...
:keywords: {admc-name}, kubewarden, Kubernetes, Richtlinien in TypeScript schreiben, neue Validierungsrichtlinie
:doc-type: Anleitung
:doc-topic: {admc-name}, kubewarden, Richtlinien schreiben, TypeScript, eine neue Validierungsrichtlinie erstellen
