...
:description: Befolgen Sie diese wesentlichen Schritte, um Richtlinien effektiv für Ihr {admc-name}-Setup zu erstellen und zu verteilen.
...
{admc-name} dokumentiert die Verteilung von Richtlinien im
xref:../../../explanations/distributing-policies.adoc[Verteilen von Richtlinien]
Abschnitt.

== Weitere Beispiele

Sie finden weitere Rust {admc-short-name}-Richtlinien im GitHub-Bereich von {admc-short-name}.
...
Die {admc-short-name}-Richtlinien-Repositories, die durch diese Abfrage angezeigt werden, haben GitHub-Aktionen, die die folgenden Aufgaben automatisieren:
