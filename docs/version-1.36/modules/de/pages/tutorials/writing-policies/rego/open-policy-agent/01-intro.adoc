...
Was die Ausführung von Richtlinien betrifft, können Sie mehr über die xref:tutorials/writing-policies/rego/02-builtin-support.adoc[OPA integrierte Unterstützung] lesen, die in {admc-short-name} implementiert ist.
