...
:description: Veröffentlichen Sie {admc-name} Richtlinien im Artifact Hub, indem Sie ein gut strukturiertes Git-Repository-Layout erstellen und GitHub Actions für die automatisierte Paketierung konfigurieren, um Continuous Integration zu ermöglichen.
...
{admc-name} Richtlinien können im Artifact Hub veröffentlicht und einem breiten Publikum von CNCF-Nutzern zugänglich gemacht werden.
...
Dieses Dokument konzentriert sich auf die Schritte, die erforderlich sind, um eine {admc-short-name} Richtlinie im Artifact Hub auffindbar zu machen.
...
* Wählen Sie _"{admc-short-name} Richtlinien"_ als Art aus.
