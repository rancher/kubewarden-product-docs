...
:keywords: {admc-name}, kubewarden, kubernetes, escrevendo políticas em TypeScript, nova política de validação
:doc-type: tutorial
:doc-topic: {admc-name}, kubewarden, escrevendo políticas, TypeScript, criando uma nova política de validação
