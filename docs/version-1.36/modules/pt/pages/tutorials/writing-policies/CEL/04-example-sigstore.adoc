...
Para alcançar isso no CEL, usamos as https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[bibliotecas de extensão CEL do {admc-name} para capacidades do host] na política, particularmente a https://pkg.go.dev/github.com/kubewarden/cel-policy/internal/cel/library#Sigstore[função `githubAction`].
