...
Agora, precisamos escrever o código CEL que buscará os Ingresses existentes no cluster. Para isso, usamos a [biblioteca de extensão CEL {admc-short-name}](https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities).
