...
:description: Configure as capacidades de logging para sua política usando a integração do {admc-name} com a biblioteca SLOG e inicializando.
...
É uma crate popular, bem conhecida e se integra de forma limpa com {admc-name}.
