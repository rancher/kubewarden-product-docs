...
要在 CEL 中实现这一点，我们在策略中使用 https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[{admc-name} 的 CEL 扩展库]，特别是 https://pkg.go.dev/github.com/kubewarden/cel-policy/internal/cel/library#Sigstore[`githubAction` 函数]。
