...
Um dies in CEL zu erreichen, verwenden wir die https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[{admc-name} CEL-Erweiterungsbibliotheken für Hostfähigkeiten] in der Richtlinie, insbesondere die https://pkg.go.dev/github.com/kubewarden/cel-policy/internal/cel/library#Sigstore[`githubAction` Funktion].
