...
Em termos de execução de políticas, você pode ler mais sobre o suporte xref:tutorials/writing-policies/rego/02-builtin-support.adoc[incorporado do OPA] implementado em {admc-short-name}.
