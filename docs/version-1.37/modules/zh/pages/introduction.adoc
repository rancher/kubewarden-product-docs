...
您可以使用标准网络服务器提供{admc-short-name}策略，或者更好的是，您可以将它们发布到符合 OCI 标准的注册表中，作为https://github.com/opencontainers/artifacts[OCI 工件]。

ifeval::["{build-type}" == "community"]

== 供应商中立性

{admc-short-name} 是一个链接：https://contribute.cncf.io/maintainers/community/vendor-neutrality/[供应商中立] 项目，按照 CNCF 的定义。
