...
{admc-name}はhttps://www.sigstore.dev/[Sigstore]プロジェクトのサポートを実装します。
...
{admc-short-name}チームは、https://github.com/kubewarden/verify-image-signatures[検証ポリシー]を提供し、すべてのコンテナに対してSigstore署名を強制します。
