...
:description: Define e implementa estructuras efectivas de ajustes de directiva a través de {admc-name} directivas en los archivos src/types.ts y src/index.ts.
:keywords: "{admc-name}", Kubewarden, kubernetes, definiendo ajustes de directiva, TypeScript
:doc-type: tutorial
:doc-topic: {admc-name}, Kubewarden, escritura-de-directivas, TypeScript, definiendo-ajustes-de-directiva
...
Escribir en STDOUT rompe las directivas. En su lugar, utiliza STDERR para el registro o el mecanismo de registro proporcionado por el {admc-name} SDK. La salida de la directiva a STDOUT debe contener únicamente la respuesta de validación.
====
...
Las directivas de {admc-short-name} utilizan dos funciones que manejan ajustes:
