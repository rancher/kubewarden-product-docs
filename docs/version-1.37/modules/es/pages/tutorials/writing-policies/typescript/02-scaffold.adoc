...
:keywords: {admc-name}, kubewarden, kubernetes, escribiendo directivas en TypeScript, nueva directiva de validación
:doc-type: tutorial
:doc-topic: {admc-name}, kubewarden, escribiendo-directivas, typescript, creando una nueva directiva de validación
