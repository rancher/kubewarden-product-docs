...
Para lograr esto en CEL, utilizamos las https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[bibliotecas de extensión CEL de {admc-name} para capacidades del host] en la directiva, particularmente la https://pkg.go.dev/github.com/kubewarden/cel-policy/internal/cel/library#Sigstore[función `githubAction`].
