...
También necesitas actualizar la estructura `ValidationResponse` y la función `MutateRequest` en `kw_sdk.go` para eliminar los tipos específicos de Kubernetes y usar tipos {admc-short-name} en su lugar:
