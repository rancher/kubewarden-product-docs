...
:description: Publier {admc-name} stratégies sur Artifact Hub en créant une mise en page de dépôt Git bien formatée et en configurant GitHub Actions pour l'emballage automatisé, facilitant l'intégration continue.
...
Les stratégies {admc-name} peuvent être publiées sur Artifact Hub et rendues découvrables par le large public des utilisateurs de CNCF.
...
Ce document se concentre sur les étapes nécessaires pour rendre une stratégie {admc-short-name} découvrable sur Artifact Hub.
...
* Choisissez _"{admc-short-name} stratégies"_ comme type :
