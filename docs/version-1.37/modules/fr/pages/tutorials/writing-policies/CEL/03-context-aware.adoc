...
Maintenant, nous devons écrire le code CEL qui récupérera les Ingress existants dans le cluster. Pour cela, nous utilisons la [{admc-short-name}bibliothèque d'extensions CEL](https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities).
