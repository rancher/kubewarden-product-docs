...
= Security disclosure
:description: Investigative security researchers work with the Admission Controllers team to identify vulnerabilities using responsible disclosure protocols.
:revdate: 2025-11-25
