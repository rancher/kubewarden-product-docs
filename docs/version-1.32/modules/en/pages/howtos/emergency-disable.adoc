...
= Emergency disable
:description: Learn how to disable the SUSE Security Admission Controller in emergency situations, stopping and deleting related configurations, and then restore.
:revdate: 2025-11-25
