...
= Audit Scanner
:description: Verify the compliance state of your clusters using the Audit Scanner feature within SUSE Security Admission Controller, to ensure their proper configuration.
:revdate: 2025-11-25
