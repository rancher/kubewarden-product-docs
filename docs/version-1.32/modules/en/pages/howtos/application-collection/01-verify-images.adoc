...
:description: Learn how to configure PolicyServers to verify applications and images from the Rancher Application Collection by creating a Docker Config Secret
