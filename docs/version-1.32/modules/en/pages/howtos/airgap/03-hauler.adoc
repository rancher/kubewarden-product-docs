...
:description: Configure Hauler capabilities to generate a manifest file with all necessary resources needed for running Kubewarden in private environments via a secure
