...
= Metrics quickstart
:description: Configure metrics reporting on the Policy Server using Prometheus and Admission Controller enabled through Helm charts for data collection.
:revdate: 2025-11-25
