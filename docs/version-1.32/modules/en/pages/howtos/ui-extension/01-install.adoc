...
:description: Learn how to install the SUSE Security Admission Controller UI as an extension of Rancher Manager with a step-by-step guide through the installation process
:revdate: 2025-11-25
