...
:description: Learn how to configure and view metrics for a Policy Server, or for specific policies, using Ranchers Cluster Tool in conjunction with Grafana and Prometheus
...
These steps are an adpatation from the
