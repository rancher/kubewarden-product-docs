...
= Quick start
:description: Understand the Admission Controller stack by learning how to deploy and manage its main components, including PolicyServers and ClusterAdmissionPolicy resources.
:revdate: 2025-11-25
