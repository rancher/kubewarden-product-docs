...
= Logging
:description: Configure logging capabilities for your policy by using the SUSE Security Admission Controller's integration with the SLOG library and initializing.
:revdate: 2025-11-25
