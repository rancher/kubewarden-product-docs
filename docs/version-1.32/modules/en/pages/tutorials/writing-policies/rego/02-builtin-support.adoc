...
:description: Configure and utilize the built-in support for executing WASM binaries in Kubewarden policies to access provided functions directly or via SDK implementation
