...
:description: Configure and distribute your Rego policy with the Open Policy Agent by annotating it, pushing it to an OCI registry, then create a ClusterAdmissionPolicy
