...
:description: Here is the corrected sentence Learn about creating a new validation policy for Kubernetes using Go in this step-by-step tutorial that covers policy settings
