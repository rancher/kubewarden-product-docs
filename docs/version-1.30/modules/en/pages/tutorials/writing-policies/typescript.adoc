...
:description: Writing {project-name} policies with Typescript
...
Currently, there's no {project-name} SDK for AssemblyScript.
...
has a {short-project-name} Policy written in AssemblyScript.
