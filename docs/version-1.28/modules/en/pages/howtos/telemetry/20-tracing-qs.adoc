...
:description: Configure tracing support for the Policy Server by installing Jaeger components, setting up the OpenTelemetry collector, and defining a ClusterAdmissionPolicy.
