...
:description: Deploy custom admission policies in Kubernetes with Kubewardens CEL policy, which enables running Validating Admission Policies without modification.
