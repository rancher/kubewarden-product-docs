...
:description: Learn how to interact with container registries, including images and artifacts, as well as OCI objects, using the Kubewarden hosts capabilities.
