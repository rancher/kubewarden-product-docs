...
ifdef::pdf-generation[]
There is a full list of https://artifacthub.io/packages/search?ts_query_web=kubewarden&sort=relevance&page=1[available policies] on ArtifactHub.
endif::[]
