...
The examples show the use of https://docs.sigstore.dev/cosign/installation/[`cosign`] and https://github.com/kubewarden/kwctl[`kwctl`] utilities for signing and inspecting policies.
