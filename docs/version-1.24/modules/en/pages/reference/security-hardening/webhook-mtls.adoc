= Secure webhooks with mutual TLS
...
See https://docs.kubewarden.io/howtos/security-hardening/webhook-mtls/[this
...
server and the audit scanner processes can access them. See the
