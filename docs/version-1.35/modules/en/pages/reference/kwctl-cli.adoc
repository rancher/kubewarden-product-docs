...
* `--allowed-host-capabilities <ALLOWED-HOST-CAPABILITIES>` — Host capabilities the policy is allowed to use. Use `*` to allow all. Can be repeated multiple times. Examples: `oci/*`, `net/v1/dns_lookup_host`. Default value: `*`
